...
return {
	...
	},
	{
		...
		--		silent = true
		--	}),
		-- Find and replace within function {}
		vim.keymap.set('n', '<leader>gr', 'gd[{V%::s/<C-R>///gc<left><left><left>', { desc = 'Rename Local' }),
		-- Find and replace within the whole file	
		vim.keymap.set('n', '<leader>gR', 'gD:%s/<C-R>///gc<left><left><left>', { desc = 'Rename Global' }),
	},
	--{
	--'saecki/crates.nvim'],
